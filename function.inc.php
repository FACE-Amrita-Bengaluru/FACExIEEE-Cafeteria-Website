...
function send_email($email,$html,$subject){
	...
	$mail->SMTPSecure="tls";
	$mail->SMTPAuth=true;
	$mail->Username="webbddevv@gmail.com";
	$mail->Password="Testtube123";
	$mail->SetFrom("webbddevv@gmail.com",'The Cafe');
...
<html>
  ...
  <body>
    <span class="preheader">This is an invoice for your purchase on The Cafe</span>
          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                ...
                THE&emsp;CAFE 
                <!-- <img src="<?php echo FRONT_SITE_PATH?>assets/img/logo/logooo.png"> -->
              </a>
              </td>
            </tr>
            <!-- Email Body -->
